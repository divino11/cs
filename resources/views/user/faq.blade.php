        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <p>Please note - You might not know but Coindera is built and maintained by me (<a
                            href="https://adamevers.com">Adam</a>). Unfortunately, I'm not a Bitcoin millionaire, just a
                    guy that loves Bitcoin and was disappointed with other alert systems. I don't have a support staff,
                    it's just me.&nbsp;I’ll get back to you just as soon as I can.&nbsp; Thank you for your patience.
                </p>
                ...
                <blockquote>
                    <p>Example - if you set an alert to monitor a 2% increase in the buy price within 1 day everytime we
                        check the market you've selected we will then compare it with the data we have from exactly 24
                        hours previous.</p>
                </blockquote>
                ...
                <blockquote>
                    <p>Maybe. It really depends on if they have an API and how easy it will be to integrate it. Feel
                        free to email us at <a href="mailto:support@coindera.com">support@coindera.com</a> to request a
                        market. </p>
                </blockquote>
                ...
                <blockquote>
                    <p>Maybe, Coindera is a side project. Feel free to request it and I'll do my best to add it when I
                        can.</p>
                </blockquote>
                <h4><strong>Can I delete my account?</strong></h4>
                <blockquote>
                    <p>Sad to see you go but yes of course you can. <a href="https://app.coindera.com/users/delete">Click
                            Here.</a></p></blockquote>
                <p><br>
                </p>
            </div>
