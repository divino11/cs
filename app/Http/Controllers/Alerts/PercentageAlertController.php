...
use App\Exchange;
use App\Http\Requests\Alerts\StorePercentageAlertRequest;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use Illuminate\Support\Facades\Auth;

class PercentageAlertController extends Controller
{
    public function create()
    {
        return view('alert.create', [
            'exchanges' => Exchange::enabled()->with('markets')->get(),
            'alert' => new Alert(['type' => AlertType::Percentage]),
        ]);
    }

    public function update(StorePercentageAlertRequest $request, Alert $alert)
    {
    ...
    public function store(StorePercentageAlertRequest $request)
    {
